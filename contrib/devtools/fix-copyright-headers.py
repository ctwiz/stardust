...
// Copyright (c) 2009-2012 The Stardust Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Stardust/$1-%s The Stardust/' %s"
REGEX_CURRENT= re.compile("%s The Stardust" % year)
