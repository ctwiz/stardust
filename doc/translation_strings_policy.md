...
This document provides guidelines for internationalization of the Stardust Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `stardust_en.ts` remains unchanged.
