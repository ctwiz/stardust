Download URL: https://sourceforge.net/projects/stardust/files/Stardust/stardust-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 DST fee schedule (users still pay 0.01 DST per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #stardust00 - #stardust99
