Stardust Core version 0.10.4 is now available from:

  <https://stardust.org/bin/stardust-core-0.10.4/>
...
- #6953 `43c2789` Split stardust-tx into its own package
- #6953 `dfe0d4d` Include stardust-tx binary on Debian/Ubuntu
