Stardust version 0.5.4 is now available for download at:
http://sourceforge.net/projects/stardust/files/Stardust/stardust-0.5.4/
...
http://gitorious.org/stardust/stardustd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Stardust-Qt notifications under Growl 1.3.
Increase required age of Stardust-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxStardust properly when installing Stardust-Qt over it. (Windows)
