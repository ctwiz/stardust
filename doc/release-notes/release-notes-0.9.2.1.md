Stardust Core version 0.9.2.1 is now available from:

  https://stardust.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 DST to 0.01 DST
...
- Fix "Start stardust on system login"
