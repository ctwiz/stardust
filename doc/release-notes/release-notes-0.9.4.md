Stardust Core version 0.9.4 is now available from:

  https://stardust.org/bin/0.9.4/
...
this update is incompatible with the Stardust system and could lead to consensus
forks.

Stardust Core released binaries from https://stardust.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~stardust/+archive/ubuntu/stardust
- A third-party or self-compiled Stardust Core

upgrade to Stardust Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
