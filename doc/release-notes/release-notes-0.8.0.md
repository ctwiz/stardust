Stardust-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/stardust/files/Stardust/stardust-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Stardust
...
New/changed settings (command-line or stardust.conf file)
--------------------------------------------------------
