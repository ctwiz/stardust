// Copyright (c) 2013-2015 The Stardust Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CStardustAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CStardustAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CStardustAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CStardustAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CStardustAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CStardustAddress(arr[0].get_str()).Get() == demoAddress.Get());
