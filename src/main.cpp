...
#if defined(NDEBUG)
# error "Stardust cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Stardust Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s DST additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("stardust-scriptch");
