 ...
 */
#ifndef STARDUST_UTIL_H
#define STARDUST_UTIL_H
...
extern const char * const STARDUST_CONF_FILENAME;
extern const char * const STARDUST_PID_FILENAME;
...
{
    std::string s = strprintf("stardust-%s", name);
