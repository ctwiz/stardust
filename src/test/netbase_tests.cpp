...
{
    BOOST_CHECK(TestSplitHost("www.stardust.org", "www.stardust.org", -1));
    BOOST_CHECK(TestSplitHost("[www.stardust.org]", "www.stardust.org", -1));
    BOOST_CHECK(TestSplitHost("www.stardust.org:80", "www.stardust.org", 80));
    BOOST_CHECK(TestSplitHost("[www.stardust.org]:80", "www.stardust.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:31460", "127.0.0.1", 31460));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:31460", "127.0.0.1", 31460));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:31460", "::ffff:127.0.0.1", 31460));
    BOOST_CHECK(TestSplitHost("[::]:31460", "::", 31460));
    BOOST_CHECK(TestSplitHost("::31460", "::31460", -1));
    BOOST_CHECK(TestSplitHost(":31460", "", 31460));
    BOOST_CHECK(TestSplitHost("[]:31460", "", 31460));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:31460", "127.0.0.1:31460"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:31460", "[::]:31460"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
