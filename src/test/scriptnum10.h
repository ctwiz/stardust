...
#ifndef STARDUST_TEST_SCRIPTNUM10_H
#define STARDUST_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Stardust Core 0.10.0, for cross-comparison.
 */
public:
