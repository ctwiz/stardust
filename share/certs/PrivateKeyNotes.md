...
unlocked to sign the Stardust-Qt.app bundle.
...
allowing somebody to distribute a Stardust-Qt.app or stardust-qt-setup.exe with a valid
...
that the stardust-qt.exe file inside the installer had not been tampered with.
