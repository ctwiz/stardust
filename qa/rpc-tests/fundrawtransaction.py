...
class RawTransactionsTest(StardustTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid stardust address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid stardust address" in e.error['message'])
